...
/*const uint16_t* const Zeldastr[2] PROGMEM = {
	ZeldaNote, Zeldatime
	};
	
uint16_t * ptr, showBuffer[11];
ptr = (uint16_t *) pgm_read_word (& Zeldastr)
*/

/*
static const uint16_t PROGMEM timeDelay[43] = {
	 180, 180, 450, 180, 180,
	 450, 400, 200, 180, 180,
	 180, 180, 400, 300, 300,
	 200, 200, 600, 300, 300,
...
for lengthof(Zeldanote)
	read_progmem stuff
 setbuzzer frequency(struct.note)
 while (!struct.time)
	delay
